        ...
        <main>
          ...
          <div className="boxWithScroll">
            ...
            <p>
              ...
              testament to what we have learned not only from DCI (Digital
              Career Institute GmbH), but also from each other and with that
              embarking on the journey of self-discovery, continuous learning
              and improvement that is programming.
            </p>
            <h4 className="topmargin">The games</h4>
            <p>
              Tennis (mainly programmed by Donnie) is inspired by the arcade
              video game Pong.
            </p>
            <p>
              <br />
