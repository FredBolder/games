      ...
      <main>
        ...
        <div className="boxWithScroll">
          ...
          <h5>
            ...
            it, and the choices you have regarding your information. Please read
          ...
          <ol>
            <li>
              ...
              <ul>
                <li>
                  We collect and store the following information from the users:
                  first name, user name, email address, password (encrypted),
                  the completed levels and the last played level to enhance your
                  user experience.
                </li>
              </ul>
            </li>
